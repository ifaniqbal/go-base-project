...
func (_m *HttpServer) Group(relativePath string, handles ...httpserver.HandlerFunc) httpserver.RouteHandler {
...
func (_c *HttpServer_Group_Call) Run(run func(relativePath string, handles ...httpserver.HandlerFunc)) *HttpServer_Group_Call {
...
func (_c *HttpServer_Group_Call) Return(_a0 httpserver.RouteHandler) *HttpServer_Group_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *HttpServer_Group_Call) RunAndReturn(run func(string, ...httpserver.HandlerFunc) httpserver.RouteHandler) *HttpServer_Group_Call {
	_c.Call.Return(run)
	return _c
}
